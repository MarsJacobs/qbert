...
def build_model(args, task, QuantOps):
    return ARCH_MODEL_REGISTRY[args.arch].build_model(args, task, QuantOps)
    #/home/ms/workspace/git/Ibert-fp/fairseq/models/roberta/model.py(102)build_model()
