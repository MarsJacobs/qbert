...
class SentencePredictionTask(FairseqTask):
    ...
    def build_model(self, args, QuantOps):
        from fairseq import models
        model = models.build_model(args, self, QuantOps) #/home/ms/workspace/git/Ibert-fp/fairseq/models/__init__.py(47)build_model()
