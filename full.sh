...
CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py --arch roberta_base --task $1 --lr_scale $3 --clip_wd $4 \
--senqnn_config "{'quantize':$2, 'nbits_w':${NBITS_W}, 'nbits_a':${NBITS_A}, \
'act_clip_init_val': ${act_clip_init_val},'act_clip_init_valn': ${act_clip_init_valn}, \
'weight_clip_init_val': ${weight_clip_init_val}, \
'pact_decay_a':${ACT_CLIP_DECAY}, 'pact_decay_w':${WEIGHT_CLIP_DECAY}}"
