...
class TransformerSentenceEncoder(nn.Module):
    ...
    def build_embedding(self, vocab_size, embedding_dim, padding_idx, senqnn_config=None):
        ...
        if self.senqnn_config['quantize'] and self.senqnn_config['emb_quantize']:
            ...
            if self.senqnn_config['method'] == 0:
                return self.ops.LSQEmbedding(vocab_size, embedding_dim, padding_idx, senqnn_config=senqnn_config) # MSKIM Quantize Word Embedding
    ...
    def forward(
        ...
        x = self.embed_tokens(tokens) # tokens size 16*72
