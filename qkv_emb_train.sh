...
CUDA_VISIBLE_DEVICES=$1,2 python run.py --arch roberta_base --task SST-2 --lr_scale 1000 --clip_wd 0.5 --base_model $2 \
...
'pact_decay_a':${ACT_CLIP_DECAY}, 'pact_decay_w':${WEIGHT_CLIP_DECAY}, 'ffn_quantize': False, 'emb_quantize':True, 'qkv_quantize':True, \
